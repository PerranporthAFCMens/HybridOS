...
const frame=document.getElementById('adminContentFrame'),nav=document.getElementById('adminFrameNav'),gymName=document.getElementById('adminFrameGym');
let currentView='';
...
async function init(){
 ...
 currentView=start;drawNav();frame.src=embeddedUrl(start);
}
