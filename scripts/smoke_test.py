...
CRITICAL={'index.html':['app-consistency.css','app-stability.js','shared-admin-nav.js'],'member.html':['app-consistency.css','app-stability.js','social-nav.js','member-experience.css','member-experience.js'],'member-preview.html':['app-consistency.css','app-stability.js','social-nav.js','member-preview-classes.js','member-preview-controls.js','member-experience.css','member-experience.js'],'classes.html':['app-consistency.css','app-stability.js','calendar-mobile.js','calendar-views.js','session-manager.js','class-admin-enhancements.js','class-admin-live-refresh.js'],'staff.html':['app-consistency.css','app-stability.js','staff-shell.js','staff-operations.css','staff-operations.js'],'social.html':['app-consistency.css','app-stability.js','social-enhancements.js','window.__hybridSocial']}
JS=('app-stability.js','social-nav.js','shared-admin-nav.js','account-menu.js','calendar-mobile.js','calendar-views.js','scheduling-engine.js','session-manager.js','tenant-branding.js','pb-workout-enhancements.js','member-preview-classes.js','member-preview-controls.js','member-experience.js','class-admin-enhancements.js','class-admin-live-refresh.js','staff-shell.js','staff-operations.js','social-enhancements.js')
