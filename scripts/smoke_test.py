...
for x in ('requestAnimationFrame(frame)','reorderPreviewToMatch','member-layout-dragging','lostpointercapture','tile-placeholder','window.scrollBy','previewOrderWithPlaceholder'):
