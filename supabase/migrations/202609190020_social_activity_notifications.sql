...
-- Database migration applied to project mzgnhmeydhhpzgxlgudh.
-- Keeps notification generation server-side so Member Portal badges do not depend on a browser being open.
